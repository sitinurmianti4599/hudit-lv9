...
<body>
    ...
    <div>
        ...
        Masukkan kode Registration: <b>{{ $customer->registration }}</b> <br>
        Jangan teruskan atau berikan kode diatas kepada siapa pun.<br><br>
        
        Jika ada pertanyaan tambahan atau perubahan yang perlu Anda sampaikan, jangan ragu untuk menghubungi admin kami melalui WhatsApp <a href="https://api.whatsapp.com/send?phone=082399535262">Admin</a><br>
