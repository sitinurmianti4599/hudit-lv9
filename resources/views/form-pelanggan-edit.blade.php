        ...
        <div class="col-md-8 col-sm-12 mt-5" style="margin: 0 auto; ">
            <div class="x_panel me-2" style="background:url(assets/images/pattern_h.png); ">
                ...
                <div class="col-md-12 field  form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <input class="form-control" type="text" value="{{ $customer->service->name }}" name="service_id"
                            readonly>
                    </div>
                </div>
                ...
                <div class="col-md-12 field  form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <input type="date" id="order_date" name="order_date"
                            value="{{ old('order_date', date('Y-m-d', strtotime($customer->order_date))) }}" required
                            @class([
                                'form-control',
                ...
                <div class="col-md-12 field  form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <input type="date" id="done_date" name="done_date"
                            value="{{ old('done_date', $customer->done_date ? date('Y-m-d', strtotime($customer->done_date)) : '') }}"
                            @class([
                                'form-control',
